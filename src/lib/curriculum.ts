    ...
    sections: [
      {
        ...
        topics: [
          ...
          t(
            "strings",
            "Strings & String Pool",
            "Immutability, intern pool, StringBuilder vs StringBuffer.",
          ),
      ...
      },
      {
        ...
        topics: [
          ...
          t(
            ...
            "ArrayList vs LinkedList",
            "Backing arrays vs nodes, complexity.",
          ),
      ...
      },
      {
        ...
        topics: [
          ...
          t(
            "java-memory-model",
            "Java Memory Model",
            "Happens-before, reordering, safe publication.",
          ),
          ...
          t(
            ...
            "Thread-Safety Patterns",
            "Immutability, confinement, delegation.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        topics: [
          ...
          t(
            "distributed-tracing",
            "Distributed Tracing",
            "OpenTelemetry, spans, context propagation.",
          ),
      ...
      },
      {
        ...
        topics: [
          ...
          t(
            ...
            "Schema Design Patterns",
            "Bucket, extended reference, subset.",
          ),
